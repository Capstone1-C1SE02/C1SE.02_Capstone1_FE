...
import styles from './ManagementAcademic.module.scss';
                ...
                <Table striped bordered hover>
                    <thead>
                        <tr style={{ fontWeight: 700 }}>
                            <th style={{ width: '10%' }}>Mã CTDT</th>
                            <th style={{ width: '10%' }}>Tên CTDT</th>
                            <th style={{ width: '20%' }}>Loại hình ĐT</th>
                            <th style={{ width: '10%' }}>Thời gian ĐT</th>
                    ...
                    <Form className={cx('row row-form', 'form-main-add')}>
                        <div className={cx('col')}>
                            ...
                            <Form.Group controlId="">
                                <Form.Label>Loại hình ĐT</Form.Label>
                        ...
                        <div className={cx('col')}>
                            <Form.Group className={cx('mb-3')} controlId="formGroupEmail">
                                <Form.Label>Tên CTDT</Form.Label>
                                <Form.Control type="text" className={cx('form-input')} />
                            </Form.Group>
                            <Form.Group controlId="">
                                <Form.Label>Thời gian ĐT</Form.Label>
                                <Form.Control type="text" className={cx('form-input')} />
                            </Form.Group>
                            <Form.Group controlId="">
                    ...
                    {getUser.map((user) => (
                        <Form key={user?.id} className={cx('row row-form', 'form-main-add')}>
                            ...
                            <div className={cx('col')}>
                                ...
                                <Form.Group controlId="">
                                    <Form.Label>Thời gian ĐT</Form.Label>
                                    <Form.Control className={cx('form-input')} />
                                </Form.Group>
                                <Form.Group controlId="">
                                    <Form.Label>Tên ngành</Form.Label>
                                    <Form.Select className={cx('form-input')} />
